...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Moracoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"moracointools.com", "moracointools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"moracointools.com", "testnet-seed.moracointools.com"},
    {"xurious.com", "testnet-seed.mora.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Moracoin is probably already running."), addrBind.ToString().c_str());
        else
