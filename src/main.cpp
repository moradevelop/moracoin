...
#if defined(NDEBUG)
# error "Moracoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xcd3eeee1f2ab953fe8ed221dcd5d906fa844ab1a65c2201b65efc236d33da1b6");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Moracoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Moracoin Signed Message:\n";
...
{
    // Moracoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 6 * 30; // Moracoin: 3 minutes
static const int64 nTargetSpacing = 1 * 60; // Moracoin: 1 minute
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Moracoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Moracoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xcd3eeee1f2ab953fe8ed221dcd5d906fa844ab1a65c2201b65efc236d33da1b6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Newsmax 18/Jan/2016 RNC Replaces NBC With CNN for February Debate";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049718210fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1453117643;
        ...
        assert(block.hashMerkleRoot == uint256("0x8b00dd121e78a7f856b73bb38e2cf9c08fb2b5cca3d9518c696980f05fb9055e"));
...
unsigned char pchMessageStart[4] = { 0xff, 0xc4, 0xb2, 0xdb }; // Moracoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MoracoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MoracoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static MoracoinMiner(CWallet *pwallet)
{
    printf("MoracoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("moracoin-miner");
    ...
    try  loop {
        ...
        printf("Running MoracoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("MoracoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&MoracoinMiner, pwallet));
}
